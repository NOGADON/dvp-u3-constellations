...
#Gamma Draconis -1.36, -92.0, 116 
x1 = [-1.36]
y1 = [-92.0]
z1 = [116]

fig_draconis= plt.figure()
fig_draconis.add_subplot(1,1,1,projection="3d")
gamma_draconis= plt.scatter(x1,y1,z1)
plt.title('Gamma Draconis relative to SOL')
plt.show()
